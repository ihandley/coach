                ...
                <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Go to Jobs and paste a job posting URL to get started</p>
                        </div>
                    </li>
                    <li className="flex items-start gap-3">
                    ...
                    <li className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Click Match on any job to see how well it fits your background</p>
                        </div>
                    </li>
                </ul>
            </div>
