...
type CreateEvaluationServerDeps = {
  ...
  listEvaluationsByJobAndResumeProfile(input: ListEvaluationsInput): Promise<JobEvaluationRecord[]>;
};
...
export function createEvaluationServer({
  ...
  return {
    ...
    async getLatestEvaluation(input: ListEvaluationsInput): Promise<JobEvaluationRecord | null> {
