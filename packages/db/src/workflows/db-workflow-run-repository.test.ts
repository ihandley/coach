                    ...
                    returningAll() {
                      return {
                        executeTakeFirst: async () => {
                          const existing = workflowRuns.get(value);
              ...
              where(column: string, operator: string, value: string) {
                ...
                return {
                  returningAll() {
                    return {
                      executeTakeFirst: async () => {
                        const existing = workflowSteps.get(value);
            ...
            selectAll() {
              return {
                where(column: string, operator: string, value: string) {
                  ...
                  return {
                    executeTakeFirst: async () => workflowRuns.get(value) ?? undefined,
                  };
                },
                orderBy(column: string, direction: string) {
                  ...
                  return {
                    execute: async () => Array.from(workflowRuns.values()),
                  };
                },
              };
            },
                    ...
                    return {
                      execute: async () =>
                        Array.from(workflowSteps.values()).filter(
                          (step) => step.workflow_run_id === value,
                        ),
                    };
                  },
                };
