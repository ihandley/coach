...
describe("createBaselineResumeReview", () => {
  ...
  it("flags missing summary and missing skills as improvement opportunities", async () => {
    ...
    expect(review.concerns).toContain("Experience entries do not include bullet-level highlights.");

    expect(review.recommendedImprovements).toContain("Add a clear target-role headline.");
