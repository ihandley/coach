import type { NormalizedResume, ResumeProfile, ResumeSource, ResumeVersion } from "./types";
...
export type CreateResumeProfile = (input: CreateResumeProfileInput) => Promise<{
  profile: ResumeProfile;
  version: ResumeVersion;
}>;

type ResumeProfileRepository = {
  createResumeProfile(input: { name: string; currentVersionId: string }): Promise<ResumeProfile>;
