...
export class RepositoryBackedJobImporter {
  constructor(private readonly dependencies: RepositoryBackedJobImporterDependencies) {}
  ...
  async importJobFromUrl(url: string) {
    ...
    let createdJobRecord: Awaited<ReturnType<JobRepository["createJob"]>> | undefined;
